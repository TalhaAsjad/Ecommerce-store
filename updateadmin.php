...
include "sessioncheck.php";
 ...
 if(isset($_GET["id"])){ 
        $id = $_GET["id"];
        $show = "SELECT * FROM `admin` where id = ".$id." limit 1";
    ...
    if(isset($_POST["fullname"])){ 
        ...
        $myrole = $_POST['role'];
        $sql = "UPDATE `admin` SET `user_name`='".$myusername."',`email`='".$myemail."',`password`='".md5($mypassword)."',`status`='".$mystatus."',`role`='".$myrole."' WHERE `id` = ".$id." ";
