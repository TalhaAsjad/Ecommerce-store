  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="mt-5">Customer Table</h1>
          </div>
...
if(!empty($_POST)){
    ...
    $number = $_POST['number'];
      ...
      $insertquery= "INSERT INTO customer(user_name,email,password,number) values('".$user_name."', '".$email."','".md5($password)."',
       '".$number."' )";
...
<div class="form-group">
<label>Number</label>
<input type="password" name="number" id="password" class="form-control" placeholder="Number">
</div>
<div class="form-group">
...
include 'dbcon.php';
      ...
      $displayquery = "SELECT * FROM `customer`";
      ...
      <div class="card-body">
        ...
        while($row =mysqli_fetch_array($result)){ 
         ...
         <tr>
          ...
          <a href="updatecustomer.php?id=<?php echo $row['id']; ?>" class="edit btn btn-secondary" >Edit</a>
          <a href="deletecustomer.php?id=<?php echo $row['id']; ?>" class="delete btn btn-danger" >Delete</a>
